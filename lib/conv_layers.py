...
class DDTPConvLayer(nn.Module):
    ...
    def feedback_activationfunction(self, x: Tensor) -> Tensor:
    ...
    def backward(self, output_target: Tensor, layer_activation: Tensor, output_activation):
    ...
    def compute_forward_gradients(self, h_target, h_previous, forward_requires_grad=False):
        ...
        self._forward_feedback_distance = utils.compute_average_batch_distance(
            h_target, self.activations, is_gradient=False
        )
